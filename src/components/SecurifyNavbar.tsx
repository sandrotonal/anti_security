          ...
          <div className="flex items-center gap-2">
            ...
            {!premiumStatus?.valid && onRestoreSubscription && (
              <button
                ...
                className="hidden sm:flex items-center justify-center bg-neutral-900/90 hover:bg-neutral-800 text-white border border-white/10 rounded-full w-11 h-11 transition-all select-none cursor-pointer"
              >
                    ...
                    <div className="px-1 py-1 border-t border-[#30363d] space-y-1">
                      ...
                      {!premiumStatus?.valid && onRestoreSubscription && (
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-xs text-[#58a6ff] hover:text-white hover:bg-white/5 rounded-xl font-mono transition-colors lowercase flex items-center justify-between cursor-pointer"
                        >
